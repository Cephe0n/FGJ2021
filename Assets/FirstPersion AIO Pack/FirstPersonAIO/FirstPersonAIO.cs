...
walkSpeedInternal = walkSpeed;
    ...
    public class FPAIO_Editor : Editor{
        ...
        #region Movement Setup
            ...
            t.walkSpeed = EditorGUILayout.Slider(new GUIContent("Walk Speed","Determines how fast the player walks."),t.walkSpeed,0.1f,500);
            ...
            t.sprintSpeed = EditorGUILayout.Slider(new GUIContent("Sprint Speed","Determines how fast the player sprints."),t.sprintSpeed,0.1f,500);
